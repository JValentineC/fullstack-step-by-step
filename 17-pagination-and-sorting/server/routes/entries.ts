...
// GET /api/entries — paginated, sortable, filterable by tag
//   ?page=1  &limit=10  &sort=createdAt  &order=desc  &tag=react
...
// GET /api/entries/tags — list all unique tags across all entries
